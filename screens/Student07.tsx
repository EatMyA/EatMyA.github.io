...
export default function Student07({navigation}: RootStackScreenProps<'NotFound'>) {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputName}>
        ...
        <Text style={{textAlign:'center',marginTop:12,marginBottom:30}}><Text style={{fontFamily:'OpenSans400',fontSize:12}}>Already Have an Account?</Text> <Text style={{color:'#EB2D7C',fontFamily:'OpenSans700',fontSize:14}}>Log in</Text></Text>
        ...
        <View style={{flexDirection: "row", alignItems: "center",marginTop:20}}>
          <CheckBox onPress={()=>setCount(!count)}selected={Boolean(count)}/>
          <Text style={{fontSize: 14, fontFamily: 'urbanist600'}}>I Agree to the<Text
            style={{color: '#543393',}}> Terms and Conditions</Text></Text>
        </View>
