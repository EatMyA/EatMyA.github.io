...
export default function Student22({navigation}: RootStackScreenProps<'NotFound'>) {
      ...
      <View style={{
        ...
        <View style={styles.container}>
          ...
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            ...
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Monday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            ...
            <CheckBox
              ...
              selected={Boolean(count)}
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Tuesday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            <CheckBox
              onPress={() => setCount(!count)}
            ...
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Wednesday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            <CheckBox
              onPress={() => setCount(!count)}
            ...
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Thursday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            <CheckBox
              onPress={() => setCount(!count)}
            ...
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Friday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            <CheckBox
              onPress={() => setCount(!count)}
            ...
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Saturday</Text>
          </View>
          <View style={{flexDirection: "row", alignItems: "center",marginBottom:20}}>
            <CheckBox
              onPress={() => setCount(!count)}
            ...
            />
            <Text style={{fontFamily: 'ptSans', fontSize: 14}}>Sunday</Text>
          </View>
          <View style={{alignItems:"flex-end",top:'25%'}}>
